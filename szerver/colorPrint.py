...
class colorPrint:
	...
	def startPrintNoIP(self):
		print(Fore.YELLOW + '[*] ' + Style.RESET_ALL + 'Szerver fut, de nem lehetett IP-címet megállapítani')

	def lowPortNumberWarn(self):
		print(Fore.YELLOW + '[*] ' + Style.RESET_ALL + 'Nem javasolt 1000-nél kisebb portszámot megadni\n')

	def notValidPortNumberErr(self):
		print(Fore.RED + '[&&&] ' + Style.RESET_ALL + 'Portszám csak teljes szám lehet')
